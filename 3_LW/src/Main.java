        ...
        while (Menu.getChoicetodo() != 5) {
            ...
            switch (Menu.getChoicetodo()) {
                ...
                case 2: // Переставить слова в предложении в обратном порядке, соблюдая правила написания предложения
                    ...
                    Menu.chooseInput();
                    break;
                case 3: // Переставить слова в предложении в обратном порядке, соблюдая правила написания предложения
                    Menu.setSentenceormatrix(1);
                    Menu.chooseInput();
                    break;
                case 4: // Переставить слова в предложении в обратном порядке, соблюдая правила написания предложения
                    Menu.setSentenceormatrix(1);
                    Menu.chooseInput();
                    break;
                case 5: // Выход
